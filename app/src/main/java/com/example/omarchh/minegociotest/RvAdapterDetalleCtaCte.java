...
public class RvAdapterDetalleCtaCte extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (TipoTransaccion.equals("01")) {
            ...
            h.imageButton.setColorFilter(Color.BLUE);
    ...
    public class DetalleCtaCteVH extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public DetalleCtaCteVH(View itemView) {
            super(itemView);
            txtFecha = (TextView) itemView.findViewById(R.id.txtFechaCtaCte);
            txtTipoTransaccion = (TextView) itemView.findViewById(R.id.txtTipoTransaccion);
            txtMonto = (TextView) itemView.findViewById(R.id.txtMontoTrans);
            txtMetodoPago = (TextView) itemView.findViewById(R.id.txtMetodoPagoTrans);
            imageButton = (ImageButton) itemView.findViewById(R.id.imgInfoCancel);
            txtDescripcion = (TextView) itemView.findViewById(R.id.txtDescripcion);
            cv = (CardView) itemView.findViewById(R.id.cv_cuentaCorriente);
