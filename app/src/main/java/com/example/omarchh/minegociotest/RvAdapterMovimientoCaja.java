...
public class RvAdapterMovimientoCaja extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class MovimientoCajaVH extends RecyclerView.ViewHolder {
        ...
        public MovimientoCajaVH(View itemView) {
            ...
            txtMedioPago.setTextColor(Color.parseColor("#000000"));
            txtMotivoRetiro.setTextColor(Color.parseColor("#000000"));
            txtFecha.setTextColor(Color.parseColor("#000000"));
            txtDescripcion.setTextColor(Color.parseColor("#000000"));
